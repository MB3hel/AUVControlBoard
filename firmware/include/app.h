...
#define TASK_CMDCTRL_SSIZE                  (4*configMINIMAL_STACK_SIZE)        // May call many levels of functions
#define TASK_IMU_SSIZE                      (4*configMINIMAL_STACK_SIZE)        // May call many levels of functions
#define TASK_DEPTH_SSZIE                    (4*configMINIMAL_STACK_SIZE)        // May call many levels of functions
