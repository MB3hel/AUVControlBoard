...
int main(void){
    ...
    i2c_trans test_trans;
    test_trans.address = 0x28;
    test_trans.write_buf = wbuf;
    test_trans.read_buf = rbuf;
    test_trans.write_buf[0] = 0x2E;
    test_trans.write_count = 1;
    test_trans.read_count = 6;
