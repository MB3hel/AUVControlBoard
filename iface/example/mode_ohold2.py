...
################################################################################
# Move the vehicle using ORIENTATION_HOLD mode variant 2
################################################################################
# Author: Marcus Behel
# Date: May 10, 2023
# Version: 1.0.0
...
def run(cb: ControlBoard, s: Simulator) -> int:
    print("Setting ohold2 mode target...", end="")

    #                 x    y    z    p    r     h 
    if cb.set_ohold2(0.0, 0.0, -0.1, 5.0, 15.0, 175.0) == ControlBoard.AckError.NONE:
        print("Done.")
    else:
        print("Fail.")
        return 1
